...
`;
  ...
  getFinishedToDoCard(toDo) {
    return `<div class="flex flex-col justify-center gap-3 rounded-3xl bg-green-800 pt-3 pr-4 pb-3 pl-4 text-secondary ">
  <div class="flex items-center justify-between">
    <div class="flex items-center gap-2">
      <input type="checkbox" class="finishedToDo" />
      <div class="font-semibold">${toDo.title}</div>
      <div class="font-bold text-green-500">Done</div>
    </div>
